...
public class Main
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		UUAPI.USERNAME = "wwj112682";		//用户帐号和密码(非开发者帐号)，在打码之前，需要先设置好，给用户留一个输入帐号和密码的地方
		UUAPI.PASSWORD = "112682";
		...
		String picPath	= "c:/createImage.jpg";	//测试图片的位置
